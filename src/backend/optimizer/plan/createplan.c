...
static MergeJoin *create_zigzagjoin_plan(PlannerInfo *root, MergePath *best_path);
...
create_join_plan(PlannerInfo *root, JoinPath *best_path)
{
	...
	switch (best_path->path.pathtype)
	{
		case T_MergeJoin:
			...
			break;
		case T_ZigzagJoin:
			plan = (Plan *) create_zigzagjoin_plan(root,
												  (MergePath *) best_path);
			break;
		case T_HashJoin:
...
// todo
static MergeJoin *
create_zigzagjoin_plan(PlannerInfo *root,
					  MergePath *best_path)
{
	MergeJoin  *join_plan;
	Plan	   *outer_plan;
